...
@Data @TableName("supervision_task_execution") public class TaskExecution{
 @TableId(type=IdType.AUTO)private Long id;private Long taskId;private Long ownerAccountId;private Long triggeredByAccountId;private Integer status;private String result;private LocalDateTime startTime;private LocalDateTime endTime;
