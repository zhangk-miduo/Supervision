...
@Slf4j @Service public class TaskExecutionEngine{
 ...
 public Long execute(Long taskId){return execute(taskId,"MANUAL",null);}
 public Long execute(Long taskId,String triggerType){return execute(taskId,triggerType,null);}
 public Long execute(Long taskId,String triggerType,Long triggeredByAccountId){
  ...
  try{
   ...
   if(!definition.isEmpty()){
    definition.put("taskId",taskId);definition.put("executionId",execId);definition.put("callerAccountId",task.getOwnerAccountId());definition.put("idempotencyKey","task-"+taskId+"-execution-"+execId);
